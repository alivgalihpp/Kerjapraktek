...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['pengaduan'] = $this->model->getDataPengaduan();
    ...
    public function laporan()
    {
        ...
        $data = [
            'judul' => 'Cetak Laporan',
            'user' => $this->user,
            'jenis' => $this->model->getJenisPengawasan(),
            'instansi' => $this->model->getNamaInstansi(),
            'tim' => $this->model->getJenisTim()
        ];
    ...
    public function cetak_laporan()
    {
        ...
        if (isset($_POST['btn-cek'])) {
            ...
            $this->dompdf->render();
            $this->dompdf->stream('Laporan Simwas Inspektorat.pdf', ['Attachment' => true]); // false atau 0 untuk preview sebelum download
